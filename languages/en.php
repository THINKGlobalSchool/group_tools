...
%s",
		...
		'group_tools:cleanup:actions' => "Hide the group actions menu",
		'group_tools:cleanup:actions:explain' => "Depending on your group setting, users can directly join the group or request membership. This option will hide the actions menu completely",
